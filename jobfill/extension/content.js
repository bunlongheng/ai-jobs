...
(() => {
  ...
  function flash(el, ok) {
    try {
      ...
      t.style.outline = ok ? "3px solid #16a34a" : "3px solid #dc2626";
      t.style.outlineOffset = "2px";
      t.scrollIntoView({ block: "center", behavior: "smooth" });
      if (ok) setTimeout(() => { t.style.outline = ""; t.style.outlineOffset = ""; }, 1600);
    } catch (e) {}
  }
  ...
  // serverRules come from localhost:7777/rules (rules.json) and take precedence -
