...
const contact = [id0.email, "(978) 677-0861", "Pelham, NH", "bunlongheng.com", "linkedin.com/in/bunlongheng", "github.com/bunlongheng"].filter(Boolean).map(esc).join(" &nbsp;&middot;&nbsp; ");
...
function html(md) {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><style>
    ...
    <div class="name">${esc(id0.name || "Bunlong Heng")}</div>
