...
"$NODE" auto_email_apply.mjs --send   # send kit_ready HN jobs by email AS you (needs gmail.send via gmail_auth.mjs); skips any without a real apply email; JOBS_AUTOSEND_OFF=1 to pause
